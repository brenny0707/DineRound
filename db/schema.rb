...
ActiveRecord::Schema.define(version: 20170831160720) do
  ...
  create_table "reviews", force: :cascade do |t|
    ...
    t.index ["user_id", "reservation_id"], name: "index_reviews_on_user_id_and_reservation_id", unique: true, using: :btree
  end
